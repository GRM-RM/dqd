...
<table class="easyui-datagrid" id="newsList" title="审核通过新闻"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/news/passList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
