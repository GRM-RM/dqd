...
<table class="easyui-datagrid" id="newsList" title="审核未通过的新闻"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/news/rejectList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
