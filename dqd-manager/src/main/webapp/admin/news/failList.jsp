...
<table class="easyui-datagrid" id="newsList" title="待审核新闻"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/news/failList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
