...
<table class="easyui-datagrid" id="clubList" title="西甲球员"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/player/LALList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
