...
<table class="easyui-datagrid" id="clubList" title="中超球员"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/player/CSLList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
