...
<table class="easyui-datagrid" id="clubList" title="英超球员"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/player/PLLList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
