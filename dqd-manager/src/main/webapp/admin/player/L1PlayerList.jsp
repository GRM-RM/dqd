...
<table class="easyui-datagrid" id="clubList" title="法甲球员"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/player/L1List',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
