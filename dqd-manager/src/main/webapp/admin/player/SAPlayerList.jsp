...
<table class="easyui-datagrid" id="clubList" title="意甲球员"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/player/SAList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
