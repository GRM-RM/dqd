...
<table class="easyui-datagrid" id="clubList" title="德甲球队"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/club/BDLList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
