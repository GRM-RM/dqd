...
<table class="easyui-datagrid" id="clubList" title="法甲球队"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/club/L1List',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
