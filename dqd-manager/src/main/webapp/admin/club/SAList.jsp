...
<table class="easyui-datagrid" id="clubList" title="意甲球队"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/club/SAList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
