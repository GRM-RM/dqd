...
<table class="easyui-datagrid" id="clubList" title="西甲球队"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/club/LALList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
