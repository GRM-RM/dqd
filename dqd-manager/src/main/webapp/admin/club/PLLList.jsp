...
<table class="easyui-datagrid" id="clubList" title="英超球队"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/club/PLLList',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
