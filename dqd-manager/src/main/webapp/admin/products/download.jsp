...
<form id="Form1" name="Form1"
	  action="${pageContext.request.contextPath}/goodList.html"
	  method="post">
	<table cellSpacing="1" cellPadding="0" width="100%" align="center"
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tr>
						...
						<td class="ta_01" bgColor="#ffffff">
							<input type="text" name="minPrice" size="10" value="" />- <input type="text"
		...
		<tr>
			<td class="ta_01" align="center" bgColor="#afd1f3"><strong>销售榜单</strong>
			</TD>
		</tr>
		<tr>
			...
			<td class="ta_01" align="center" bgColor="#f5fafe">
				<table cellspacing="0" cellpadding="1" rules="all"
					...
					<tr
						...
						<td width="8%" align="center">商品销量</td>

						<td width="8%" align="center">删除</td>
					</tr>

					<c:choose>
						<c:when test="${pageInfo3.list==null }">
							<tr>
								<td>
									没有商品
								</td>
						...
						<c:otherwise>
							<c:forEach items="${pageInfo3.list }" var="product" varStatus="vs">
				...
				当前页：${pageInfo3.pageNum}
				共有：${pageInfo3.pages}页
				<a href="/products/list.html?id=${id}&name=${name}&minPrice=${minPrice}&
							maxPrice=${maxPrice}&type_Id=${type_Id}&pageNo=${pageInfo3.nextPage}">上一页</a>

				<c:forEach begin="${pageInfo3.navigateFirstPage}" end="${pageInfo3.navigateLastPage}" var="pn" >
					<a href="/products/list.html?id=${id}&name=${name}&minPrice=${minPrice}&
							maxPrice=${maxPrice}&type_Id=${type_Id}&pageNo=${pageInfo.nextPage}">
						<span style="${pageInfo.pageNum==pn?'font-weight:bold':''}">${pn}</span>
					</a>
				</c:forEach>

				<a href="/products/list.html?id=${id}&name=${name}&minPrice=${minPrice}&
							maxPrice=${maxPrice}&type_Id=${type_Id}&pageNo=${pageInfo3.nextPage}">下一页</a>
