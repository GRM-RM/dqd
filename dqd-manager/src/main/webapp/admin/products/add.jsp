...
<script type="text/javascript" charset="utf-8" src="/admin/kindeditor-4.1.10/lang/zh_CN.js"></script>
	...
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/products/add.html" method="post"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3">
					...
					<a href="addPhotos.jsp"> <input type="button" value="添加图片"/> </a>
	...
	<script type="text/javascript">
        function check(obj) {
            ...
            $.ajax({
                url: "/products/check.html",
                dataType: 'json',
                data:{"name":$("#name").val(),"type_Id":$("#type_Id").val()},
                method: "post",
